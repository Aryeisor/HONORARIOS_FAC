...
class GastroenterologiaRules(SpecialtyBase):
    ...
    def _is_gastro_procedure(self, contrato, proc_text):
    ...
    def process_row(
        ...
        is_gastro_proced, is_consulta, is_cuidados = self._is_gastro_procedure(contrato, proc_text)
        ...
        obs = "NO APLICA GASTROENTEROLOGIA"
        if contrato in self.contratos_aplican and (is_consulta or is_cuidados):
            obs = "GASTROENTEROLOGIA (consulta/cuidados) - sin cálculo"
        ...
        nuevo_vlr_aut = None
        if is_gastro_proced and idx_vlr_aut is not None:
        ...
        return {
            ...
            "is_coo_proced": is_gastro_proced,
        }